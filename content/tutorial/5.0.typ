...
#show: book.with(title: "五、线下礼仪")

= 五、线下礼仪
<五线下礼仪>
!!! Warning 该部分仍有一些内容存在问题，请谨慎判别！
...
按以上步骤摸牌完毕后，庄家将有 14 张牌，闲家将有 13
张牌。然后从庄家开始出牌。

在上家打出一张牌后，玩家不应该思考过长时间。长考时间请尽量控制在 20
秒以内。
...
配牌操作与四口机通用礼仪类似。骰子点确定办法如下：本局东家按下掷骰键或掷出实体骰子，得到两个六面骰子对应的点数。将两个骰子点数相加，取
\$ mod 4 \$ 获得的数确定开山家：
...
从开山家的右手边开始数，数够两个六面骰子中#strong[较小的]点数为止，然后从下一张开始庄家配牌。
...
鸣吃/碰/杠时，要把鸣得的牌横置，并根据鸣得来源确定横牌与自己手牌的相对位置。摆好后，放在自己的右手边，紧贴麻将机的边缘。以下是鸣牌示例（1
表示手牌，竖放，-表示鸣得牌，横放）：
...
暗杠时，需要先将要杠的四张牌展示出来，然后盖住两张，全部竖放，放在自己右手边紧贴麻将机边缘。以下是示例：（1
表示牌面向上，0 表示牌背向上）
...
立直时，首先喊出リーチ（riichi），然后打出立直宣言牌，立直宣言牌应横在牌河中。打出后无人和牌，则立直成立，将
1000 点棒供托放在供托位上。
